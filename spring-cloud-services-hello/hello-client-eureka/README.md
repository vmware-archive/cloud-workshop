...
```cd``` to the ```hello-client-eureka``` folder and ```../gradlew assemble && cf push``` to push the app as hello-client to the currently targeted space, using a random route
